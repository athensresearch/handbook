...
* Learn how to [run Athens locally](develop-athens/development.md#running-athens-locally) to create a development environment.
...
* Read the [contributing documentation](contributing-documentation.md) doc.
